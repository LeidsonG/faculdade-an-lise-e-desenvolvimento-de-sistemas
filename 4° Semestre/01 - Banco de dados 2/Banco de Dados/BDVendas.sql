...
create database Vendas_BDII_ADS_ENC
go
...
('19-08-2009 10:00',null,1,6,1,3)

insert into pedidos values
('19-08-2009 12:00',null,1,8,2,5)

insert into pedidos values
('19-08-2009 14:00',null,1,6,1,5)

insert into pedidos values 
('20-08-2009 10:00', null,1,8,1,3)

insert into pedidos values 
('20-08-2009 12:00', null,1,6,2,5)

insert into pedidos values 
('20-08-2009 14:00', null,1,8,2,3)
select * from pedidos
